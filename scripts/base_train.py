...
parser.add_argument("--seed", type=int, default=42, help="global random seed for model init and torch RNG")
# FP8 training
...
parser.add_argument("--dino-bottleneck-dim", type=int, default=0, help="student bottleneck dim before projecting to teacher space (0 disables)")
