...
parser.add_argument("--global-matrix-lr", type=float, default=0.0005, help="learning rate for global-branch matrices (AdamW)")
parser.add_argument("--scalar-lr", type=float, default=0.5, help="learning rate for scalars (resid_lambdas, x0_lambdas)")
parser.add_argument("--global-gate-lr", type=float, default=0.005, help="learning rate for global fusion gates")
...
optimizer = model.setup_optimizer(
    ...
    global_matrix_lr=args.global_matrix_lr * batch_lr_scale,
